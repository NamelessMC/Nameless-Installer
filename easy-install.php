...
$zip_subdir = $version == 'v1' ? 'Nameless-1.0.21' : 'Nameless-2.0.0-pr10';
            ...
            <div class="col-md-8">
                ...
                switch ($step) {
                    ...
                    case 'select': { ?>
                            ...
                            <p>NamelessMC has two versions: <b>v1 (1.0.21)</b> and <b>v2 (pr10)</b>.</p>
                            ...
                            <div class="row">
                                ...
                                <div class="card mx-auto" onclick="window.location.href='?step=verify&ver=v2'">
                                    <div class="card-body rounded" style="background-color: #21BA45">
                                        ...
                                        <hr style="background-color: white">
                                        <a href="?step=verify&ver=v2" class="btn btn-outline btn-version">v2.0.0-pr10</a>
                                    </div>
                                </div>
                            </div>
                    ...
                    case 'download': {
                            ...
                            else if ($version == 'v2') $zip_url = 'https://github.com/NamelessMC/Nameless/archive/v2.0.0-pr10.zip';
